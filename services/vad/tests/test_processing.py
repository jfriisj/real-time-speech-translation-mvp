...
def test_process_event_passes_speaker_context() -> None:
    ...
    settings = Settings(
        ...
        startup_max_wait_seconds=60.0,
        startup_initial_backoff_seconds=1.0,
        startup_max_backoff_seconds=5.0,
        startup_attempt_timeout_seconds=2.0,
        ...
        consumer_partition_assignment_strategy=None,
        consumer_enable_static_membership=False,
        consumer_group_instance_id=None,
