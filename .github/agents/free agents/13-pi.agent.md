...
handoffs:
   - label: 02 Start New Plan
      agent: 02 Planner
      prompt: "Iteration complete. Start the next plan. Inputs: agent-output/retrospectives/ and agent-output/process-improvement/."
      send: false
   - label: 01 Update Roadmap (Process Changes)
      agent: 01 Roadmap
      prompt: "Validate whether process improvements affect roadmap sequencing. Inputs: agent-output/roadmap/product-roadmap.md and agent-output/process-improvement/NNN-process-improvement-analysis.md."
      send: false
---
