...
tools: ['execute/testFailure', 'execute/getTerminalOutput', 'execute/runInTerminal', 'execute/runTests', 'read/problems', 'read/readFile', 'read/terminalSelection', 'read/terminalLastCommand', 'edit/createDirectory', 'edit/createFile', 'edit/editFiles', 'edit/editNotebook', 'search', 'analyzer/*', 'memory/*', 'ms-azuretools.vscode-containers/containerToolsConfig', 'todo']
...
12. **Metrics**: For quantitative criteria, output a machine-readable JSON artifact (e.g., `agent-output/qa/NNN-metrics.json`) to facilitate UAT.
13. Assign final status: "QA Complete" or "QA Failed" with timestamp
