...
handoffs:
  - label: 02 Revise Plan (Address Critique)
    agent: 02 Planner
    prompt: "Please revise the plan to address the critique findings.\n\nInputs:\n- Plan: agent-output/planning/NNN-feature-slug-plan.md\n- Critique: agent-output/critiques/NNN-feature-slug-plan-critique.md\n\nGoal:\n- Update plan text (WHAT/WHY) only; no implementation code.\n- Then re-submit for critique."
    send: false
  - label: 03 Request Analysis (Fill Evidence Gaps)
    agent: 03 Analyst
    prompt: "The plan has research gaps / unverified assumptions. Please investigate and report.\n\nInputs:\n- Plan: agent-output/planning/NNN-feature-slug-plan.md\n- Specific gaps/questions: [list]\n\nDeliverable:\n- Create: agent-output/analysis/NNN-feature-slug-analysis.md"
    send: false
  - label: 04 Request Architecture Review (If Needed)
    agent: 04 Architect
    prompt: "The plan appears architecturally misaligned or under-specified. Please review and provide findings.\n\nInputs:\n- Plan: agent-output/planning/NNN-feature-slug-plan.md\n\nDeliverable:\n- Create/update: agent-output/architecture/NNN-feature-slug-architecture-findings.md"
    send: false
  - label: 07 Approve for Implementation (After Fixes)
    agent: 07 Implementer
    prompt: "Plan is ready for implementation.\n\nInputs:\n- Approved plan: agent-output/planning/NNN-feature-slug-plan.md\n- Latest critique (for constraints/risks): agent-output/critiques/NNN-feature-slug-plan-critique.md\n\nDeliverable:\n- Implementation report: agent-output/implementation/NNN-feature-slug-implementation.md"
    send: false
---
Purpose:
